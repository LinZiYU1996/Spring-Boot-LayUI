...
layui.use(["form","table","element"], function(){
    ...
    var form = layui.form;
    popForm=layui.form;
    $("#display-user-log").click(function () {
        // alert("aaa");
        ...
        document.getElementById('4').className='layui-body';//替换成一个新class
        table.render({
            elem: '#userlog'
            ,url:'/u/getAllUserLog'
            ,toolbar: '#toolbarDemo'
            ...
            ,cols: [[
                ...
                ,{field:'oldUserName', title:'修改前用户名'}
                ,{field:'newUserName', title:'修改后用户名'}
                ,{field:'oldUserPwd', title:'修改前用户密码'}
                ,{field:'newUserPwd', title:'修改后用户密码'}
                ,{field:'operatorName', title:'操作用户'}
                ,{field:'operatorTime', title:'操作时间'}
                ,{field:'targetId', title:'操作对象ID'}
